...
public final class WriteCoilRequest
  ...
  public WriteCoilRequest() {
    super();
    setFunctionCode(Const_Modbus.WRITE_COIL);
  ...
  public ModbusResponse createResponse() {
    ...
    try {
      ...
      return createExceptionResponse(Const_Modbus.ILLEGAL_ADDRESS_EXCEPTION);
    }
  ...
  public void writeData(DataOutput dout)
    ...
    if (m_Coil) {
      dout.write(Const_Modbus.COIL_ON_BYTES, 0, 2);
    } else {
      dout.write(Const_Modbus.COIL_OFF_BYTES, 0, 2);
    }
  }
  ...
  public void readData(DataInput din)
    ...
    if (din.readByte() == Const_Modbus.COIL_ON) {
      m_Coil = true;
    } else {
      m_Coil = false;
    }
