...
public abstract class ModbusMessageImpl implements ModbusMessage {
  ...
  //instance attributes
  private int m_TransactionID = Const_Modbus.DEFAULT_TRANSACTION_ID;
  private int m_ProtocolID = Const_Modbus.DEFAULT_PROTOCOL_ID;
  private int m_DataLength;
  private int m_UnitID = Const_Modbus.DEFAULT_UNIT_ID;
